...
export const CardExpertise: React.FC<CardExpertiseProps> = ({ data, index }) => {
  React.useEffect(() => {
    AOS.init();
  }, []);

  return (
    <div className="w-full relative overflow-hidden" data-aos='fade-up' data-aos-delay={100 * index}>
